...
1. All the required dependencies can be installed using requirement.yml
2. Create the conda environment where myenv is the name of the environment  

    **`conda env create --name myenv --file=requirement.yml`**
